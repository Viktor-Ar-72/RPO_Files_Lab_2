...
const ArtistComponent = props => {
    ...
    // Проверено вместе с Mister Ф.И.
    const [countryid, setCountryID] = useState(16);
    ...
    const onSubmit = (event) => {
        ...
        if (!name) err = "Необходимо указать имя художника!";
        if (!age) err = "Необходимо указать годы жизни художника!";
        ...
        <div className="m-4">
            ...
            <Form onSubmit={onSubmit}>
                <Form.Group>
                    ...
                    <Form.Control
                        type="text"
                        placeholder="Введите годы жизни художника"
